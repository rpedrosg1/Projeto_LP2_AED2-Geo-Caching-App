 ...
 *  @author Kevin Wayne
 */
public class Project_SequentialSearchST<Key, Value> implements Serializable {
    private int n;           // number of key-value pairs
    private Project_SequentialSearchST.Node first;      // the linked list of key-value pairs
     ...
     */
    public Project_SequentialSearchST() {
    }
    ...
    /**
     * Unit tests the {@code Project_SequentialSearchST} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        Project_SequentialSearchST<String, Integer> st = new Project_SequentialSearchST<String, Integer>();
