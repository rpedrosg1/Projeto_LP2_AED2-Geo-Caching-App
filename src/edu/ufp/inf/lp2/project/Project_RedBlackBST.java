...
public class Project_RedBlackBST<Key extends Comparable<Key>, Value> implements Serializable {
    ...
    public static void main(String[] args) {
        Project_RedBlackBST<String, Integer> st = new Project_RedBlackBST<String, Integer>();
